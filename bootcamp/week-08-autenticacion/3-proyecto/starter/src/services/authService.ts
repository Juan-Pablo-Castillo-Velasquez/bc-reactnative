 ...
 * dummyjson.com no tiene endpoint real de registro, por lo que esta
 * función simula el registro con un delay y datos mockeados — opción
 * (b) sugerida en el TODO original, para fines de práctica.
 */
